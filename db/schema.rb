...
ActiveRecord::Schema.define(version: 2018_06_08_111602) do

  create_table "profiles", primary_key: "user_id", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
